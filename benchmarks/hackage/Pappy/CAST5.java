// $Id: CAST5.java,v 1.1 2002/09/05 19:27:05 baford Exp $
//
// $Log: CAST5.java,v $
...
//    private int[]
//        Km = new int[16],       // this cipher's masking subkeys
//        Kr = new int[16];       // and rotation ones
...
//............................................................................
    ...
    throws KeyException {
        ...
        if (userkey == null)
            throw new KeyException(getAlgorithm() + ": Null user key");

        int len = userkey.length;
        if (len < 5 || len > 16)
            throw new KeyException(getAlgorithm() + ": Invalid user key length");
