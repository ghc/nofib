...
run args =
  do quickCheckWith args prop_Invariant
     quickCheckWith args prop_Empty
     quickCheckWith args prop_Unit
     quickCheckWith args prop_Size
     quickCheckWith args prop_Insert
     quickCheckWith args prop_Delete
     quickCheckWith args prop_Union
     quickCheckWith args prop_Mapp
     quickCheckWith args prop_FromList
     quickCheckWith args prop_ToSortedList
