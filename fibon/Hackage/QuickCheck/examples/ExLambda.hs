...
main1 args =
  do quickCheckWith args prop_SubstFreeNoVarCapture
     quickCheckWith args prop_SubstNotFreeSame
     quickCheckWith args prop_SubstNotFreeSameVars
...
main2 args =
  do quickCheckWith args prop_ClosedExpIsClosed
     quickCheckWith args prop_EvalProducesValue
