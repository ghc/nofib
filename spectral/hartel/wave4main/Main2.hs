...
type 
    ...
    f_showfix a_w a_x=
        let { 
            ...
            r_d2_c=chr (((+) :: (Int -> Int -> Int)) (ord '0') (((rem) :: (Int -> Int -> Int)) (((div) :: (Int -> Int -> Int)) r_i (10 :: Int)) (10 :: Int)));
            r_d1_c=chr (((+) :: (Int -> Int -> Int)) (ord '0') (((rem) :: (Int -> Int -> Int)) (((div) :: (Int -> Int -> Int)) r_i (100 :: Int)) (10 :: Int)))
         } in  
